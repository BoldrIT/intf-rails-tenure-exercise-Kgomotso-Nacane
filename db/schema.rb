...
ActiveRecord::Schema.define(version: 2023_12_02_164156) do
  ...
  create_table "cases", force: :cascade do |t|
    ...
    t.integer "previous_step_number"
    t.integer "next_step_number"
    t.index ["candidate_fullname"], name: "index_cases_on_candidate_fullname"
